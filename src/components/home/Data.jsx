...
const Data = () => {
  return (
     <div className="home__data">
        ...
        <p className='home__description'>Enthusiastic and motivated beginner developer eager to leverage academic knowledge and hands-on experience to contribute positively to software development projects. Possess a strong foundation in programming languages and frameworks, coupled with a passion for learning and problem-solving. Seeking an opportunity
         to grow and develop skills within a collaborative team environment.</p>
